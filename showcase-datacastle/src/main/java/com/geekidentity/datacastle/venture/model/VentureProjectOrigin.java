...
public class VentureProjectOrigin {
	...
	private CrawlTime crawl_time;
	private String address;
	private Integer company_money;
	...
	public Integer getSichuan_sichuang() {
		return sichuan_sichuang;
	}
	...
	public Integer getFinance_value() {
	...
	public CrawlTime getCrawl_time() {
		return crawl_time;
	}
	public void setCrawl_time(CrawlTime crawl_time) {
	...
	public Integer getCompany_money() {
		return company_money;
	}
	public void setCompany_money(Integer company_money) {
	...
	public void setCompany_start(Date company_start) {
